...
from shopping_agent.evaluation.rollout import OpenAIChatClient, collect_tasks, load_tasks
...
def parse_args(argv: list[str] | None = None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="并发评测任务数;>1 时每个任务独占环境租约与独立模型 client。",
    )
...
def main(argv: list[str] | None = None):
    ...
    summary["protocol"] = {
        ...
        "model": args.model,
        "reward_contract": "shopping-reward-v4",
        "max_steps": args.max_steps,
        "max_tokens": args.max_tokens,
        "temperature": args.temperature,
        "top_p": args.top_p,
