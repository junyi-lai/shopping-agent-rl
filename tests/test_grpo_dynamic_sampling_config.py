...
try:
    import hydra  # noqa: F401 - GRPO 配置解析依赖 hydra
except ImportError as exc:  # hydra 只装在 GRPO 环境里
    raise unittest.SkipTest(f"hydra is unavailable: {exc}") from exc

from shopping_agent.training.rl.preflight import (
    PATCH_MARKER,
