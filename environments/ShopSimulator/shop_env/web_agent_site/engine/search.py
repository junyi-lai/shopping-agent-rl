...
class MultiFieldBM25Searcher:
    ...
    def __init__(self, index_path: str | Path, *, expected_product_sha256: str | None = None):
        ...
        try:
            self._validate(expected_product_sha256)
        except BaseException:
            self._connection.close()
            raise

    def _validate(self, expected_product_sha256: str | None) -> None:
        """Fail closed on any index that does not match the frozen contract."""
        try:
